...
func _process(delta):
	...
	if letra_A and Global.index2 == 1:
		#print("Clicou A")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_B and Global.index2 == 2:
		#print("Clicou B")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_C and Global.index2 == 3:
		#print("Clicou C")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_D and Global.index2 == 4:
		#print("Clicou D")	
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_E and Global.index2 == 5:
		#print("Clicou E")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_F and Global.index2 == 6:
		#print("Clicou F")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_G and Global.index2 == 7:
		#print("Clicou G")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_H and Global.index2 == 8:
		#print("Clicou H")	
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_I and Global.index2 == 9:
		#print("Clicou I")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_J and Global.index2 == 10:
		#print("Clicou J")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_K and Global.index2 == 11:
		#print("Clicou K")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_L and Global.index2 == 12:
		#print("Clicou L")	
		aumentar_pontuacao()
		respawn_zombie()
			
	if letra_M and Global.index2 == 13:
		#print("Clicou M")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_N and Global.index2 == 14:
		#print("Clicou N")
		aumentar_pontuacao()
		respawn_zombie()
			
	if letra_O and Global.index2 == 15:
		#print("Clicou O")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_P and Global.index2 == 16:
		#print("Clicou P")	
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_Q and Global.index2 == 17:
		#print("Clicou Q")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_R and Global.index2 == 18:
		#print("Clicou R")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_S and Global.index2 == 19:
		#print("Clicou S")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_T and Global.index2 == 20:
		#print("Clicou T")	
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_U and Global.index2 == 21:
		#print("Clicou U")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_V and Global.index2 == 22:
		#print("Clicou V")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_W and Global.index2 == 23:
		#print("Clicou W")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_Y and Global.index2 == 24:
		#print("Clicou Y")	
		aumentar_pontuacao()
		respawn_zombie()
			
	if letra_X and Global.index2 == 25:
		#print("Clicou X")
		aumentar_pontuacao()
		respawn_zombie()
		
	if letra_Z and Global.index2 == 26:
		#print("Clicou Z")	
		aumentar_pontuacao()
		respawn_zombie()		
...
func respawn_zombie():
	...
	var enemyscene = load("res://Objetos/Path2/Path2.tscn")
...
func on_particulas(zombie):
	...
	add_child(particula)
	particula.global_position = Global.position2
